...
#+begin_src emacs-lisp
  ...
  (use-package circadian
    ...
    (setq circadian-themes '((:sunrise . nano-light)
                             (:sunset  . nano-dark)))
    (circadian-setup))
...
#+begin_src emacs-lisp
  (use-package nerd-icons
    ...
    :custom (nerd-icons-font-family "NFM"))
...
#+begin_src emacs-lisp
  (use-package format-all
    :ensure t
    :diminish
    :hook ((LaTeX-mode prog-mode org-src-mode) . format-all-mode)
    :config
...
#+begin_src emacs-lisp
  (use-package hl-todo
    ...
    :hook ((prog-mode org-mode LaTeX-mode) . hl-todo-mode)
    ...
    (defun hl-todo-rg (regexp &optional files dir)
      "Use rg to find all TODO keywords."
      (interactive
       (progn
  ...
  (setq denote-templates
      ...
      (use-package consult-denote
        ...
        :bind (("C-c n f" . consult-denote-find)
               ...
               ("C-c n g" . consult-denote-ripgrep))
        :config
        (setq denote-consult-directory denote-directory))
#+end_src
...
(use-package alert
  ...
  (setq alert-default-style
        (cond
         ((eq system-type 'darwin) 'notifier)
         ((eq system-type 'gnu/linux) 'libnotify)
         ((eq system-type 'windows-nt) 'toaster)
         (t 'message))))
...
#+begin_src emacs-lisp
  ...
  (use-package org-table
    ...
    ;;   "替换 org 表格为 LaTeX 格式"
    ;;   (interactive "P")
    ;;   (unless (org-at-table-p) (user-error "不在表格中"))
    ;;   (let* ((table (org-table-to-lisp))
    ;;          (replacement-table
    ;;           (if (texmathp)
    ;;               (lazytab-orgtbl-to-amsmath table nil)
    ;;             (orgtbl-to-latex table nil))))
    ...
    ;;   "将 org 表格转换为 amsmath 格式"
    ;;   (orgtbl-to-generic
    ;;    table
    ;;    (org-combine-plists
    ;;     '(:splice t :lstart "" :lend " \\\\" :sep " & "
    ;;       :hline nil :llend "")
    ;;     params)))
