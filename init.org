  ...
  (setq org-html-head-extra
        (concat
         ...
         (format "<script src=\"%s\" defer></script>"
                 (expand-file-name "org.js" user-emacs-directory)))))
...
(use-package uv-mode
  :ensure t
  :hook (python-ts-mode . uv-mode-auto-activate-hook))   ; 自动激活核心
...
(use-package rustic
  ...
  ;; 编译成功后自动关闭缓冲区
  (rustic-quit-compile-on-success t)
  :config
  (setq rustic-lsp-client 'eglot)   ; 加到 rustic :custom 中
